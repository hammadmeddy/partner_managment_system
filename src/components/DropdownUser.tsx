...
const DropdownUser = () => {
  // const profile = useSelector((state) => state.isAdmin.isAdmin);
  ...
  return (
    <div className="relative">
      <Link
        ...
        className="flex items-center gap-0 sm:justify-between sm:gap-2"
        to="#"
      >
        <span className="w-12 ">
          <img src={user} alt="User" className="h-[38px] w-[38px]" />
        </span>
        <div className="flex flex-col">
          <span className="hidden text-sm font-semibold	text-[#1C1C1C] sm:block">
            Faizan Arshad
          </span>
      ...
      <div
        ...
        className={`absolute right-0 mt-4  flex w-[206px] flex-col rounded-[12px] border border-[#333B48] bg-[#EEEEEE]  p-[12px] shadow-[#dedede3d] ${
      ...
      >
        <div className="flex flex-col items-start justify-start gap-[6px]">
          <Link
            onClick={() => {
              setDropdownOpen(false);
              handleLinkClick("WorkSpace");
            }}
            to="/WorkSpace"
            className="sease-in-out flex items-center  gap-[10px] py-3 px-3 duration-300 "
          >
            <svg
              width="24"
              height="24"
            ...
            <span className="text-sm font-normal text-[#1D2532]">
              {" "}
              My WorkSpace
            </span>
          </Link>
          ...
          {/* <div className="flex w-full items-center justify-between">
            <Link
              ...
              to="/profile"
              className="sease-in-out flex items-center  gap-[10px] py-3 px-6 duration-300 "
            >
              <img src={dark} alt="" />
              <span className="text-sm font-normal text-[#1D2532] dark:text-white"> Dark</span>
            </Link>
