...
const Payroll = () => {
  const payrollcards = [
    {
      title: "Payroll Wage & Tax Report",
      description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      link: "View Report",
    },
    {
      title: "Payroll Benefit & Deduction Report",
      description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      link: "View Report",
    },
  ...
  return (
    <div className="rounded-xl bg-[#FFFFFF] border-[1px] border-[#ECE9E9] p-[24px] ">
      <p className="pb-3 text-[#242E3E] font-bold text-base">Payroll</p>
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2  gap-[16px] gap-y-6 mt-6">
          {payrollcards.map((payroll, index) => (
            <div
              key={index}
