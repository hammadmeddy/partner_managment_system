...
const MainPage = () => {
  return (
    <>
      <div className="lg:px-[200px] px-[80px] items-center justify-center flex-row text-center">
        <h1 className="pt-12 text-5xl font-bold text-[#111827] mb-6">
          Partner Management System – Easy Workflow (Who Does What)
        </h1>

        <p className="text-xl text-[#4B5563] max-w-xl lg:max-w-3xl mx-auto leading-relaxed">
